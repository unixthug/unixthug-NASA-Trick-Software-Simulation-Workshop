...
#define SWIGTYPE_p_SieSimObject swig_types[36]
#define SWIGTYPE_p_SimObjectVector swig_types[37]
#define SWIGTYPE_p_SubmarineSimObject swig_types[38]
...
#define SWIGTYPE_p_cv_converter swig_types[75]
...
#define SWIGTYPE_p_utEncoding swig_types[84]
#define SWIGTYPE_p_utStatus swig_types[85]
#define SWIGTYPE_p_ut_system swig_types[86]
#define SWIGTYPE_p_ut_unit swig_types[87]
#define SWIGTYPE_p_ut_visitor swig_types[88]
#define SWIGTYPE_p_v_tree swig_types[89]
...
SWIGINTERN int Swig_var_dyn_set(PyObject *_val) {
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(_val, &argp, SWIGTYPE_p_SubmarineSimObject,  0  | 0);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""dyn""' of type '""SubmarineSimObject""'");
    }
    if (!argp) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""dyn""' of type '""SubmarineSimObject""'");
    } else {
      SubmarineSimObject * temp;
      temp  = reinterpret_cast< SubmarineSimObject * >(argp);
      dyn = *temp;
      if (SWIG_IsNewObj(res)) delete temp;
    }
  }
...
SWIGINTERN PyObject *Swig_var_dyn_get(void) {
  ...
  pyobj = SWIG_NewPointerObj(SWIG_as_voidptr(&dyn), SWIGTYPE_p_SubmarineSimObject,  0 );
  return pyobj;
}
