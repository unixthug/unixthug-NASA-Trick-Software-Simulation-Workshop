...
/* Created 2023/12/12 11:39:39 caci114 $ */
#include "../S_source.hh"
...
SimEnvironment::SimEnvironment() {
    ...
    local_env["TRICK_EXEC_LINK_LIBS"] = " -lpthread -ldl -lutil -lm -lpython2.7 -Xlinker -export-dynamic -lpthread -ldl -lutil -lm -lpython2.7   -ludunits2 -lrt -lm -ldl -lhdf5_hl -lhdf5 -lgsl -lgslcblas";
    ...
    local_env["TRICK_SYSTEM_CFLAGS"] = "-isystem/home/caci114/trick/trick_source -isystem/home/caci114/trick/include -isystem/home/caci114/trick/include/trick/compat -DTRICK_VER=19 -DTRICK_MINOR=8 -fpic -I/usr/include/udunits2 -DUSE_ER7_UTILS_INTEGRATORS -D_HAVE_GSL -fexceptions ";
    setenv("TRICK_SYSTEM_CFLAGS", local_env["TRICK_SYSTEM_CFLAGS"].c_str(), 0);
    local_env["TRICK_SYSTEM_CXXFLAGS"] = "-isystem/home/caci114/trick/trick_source -isystem/home/caci114/trick/include -isystem/home/caci114/trick/include/trick/compat -DTRICK_VER=19 -DTRICK_MINOR=8 -fpic -I/usr/include/udunits2 -DUSE_ER7_UTILS_INTEGRATORS -D_HAVE_GSL ";
...
void memory_init( void ) {
    ...
    ALLOC_INFO * ai ;
    exec_set_version_date_tag( "@(#)CP Version 19.8.0-beta, Tue Dec 12 11:39:39 2023" ) ;
    exec_set_build_date( "Tue Dec 12 11:39:39 2023" ) ;
